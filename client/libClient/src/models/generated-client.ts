...
export class GenreClient {
    ...
    getAllGenre(): Promise<Genre[]> {
        let url_ = this.baseUrl + "/GetAllGenre";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetAllGenre(_response);
        });
    }

    protected processGetAllGenre(response: Response): Promise<Genre[]> {
    ...
    createGenre(dto: GenreDto): Promise<Genre> {
